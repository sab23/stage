 ...
 */
class Client extends \ProjetBundle\Entity\Client implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ProjetBundle\\Entity\\Client' . "\0" . 'id', '' . "\0" . 'ProjetBundle\\Entity\\Client' . "\0" . 'nomClient', '' . "\0" . 'ProjetBundle\\Entity\\Client' . "\0" . 'prenomClient', '' . "\0" . 'ProjetBundle\\Entity\\Client' . "\0" . 'telClient', '' . "\0" . 'ProjetBundle\\Entity\\Client' . "\0" . 'emailClient'];
        }
