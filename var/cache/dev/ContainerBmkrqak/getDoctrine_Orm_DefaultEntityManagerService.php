...
$c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, [0 => ($this->targetDirs[3].'/src/ClientBundle/Entity'), 1 => ($this->targetDirs[3].'/src/CollaborateurBundle/Entity'), 2 => ($this->targetDirs[3].'/src/ProjetBundle/Entity')]);

$b->addDriver($c, 'ClientBundle\\Entity');
$b->addDriver($c, 'CollaborateurBundle\\Entity');
$b->addDriver($c, 'ProjetBundle\\Entity');

$a->setEntityNamespaces(['ClientBundle' => 'ClientBundle\\Entity', 'CollaborateurBundle' => 'CollaborateurBundle\\Entity', 'ProjetBundle' => 'ProjetBundle\\Entity']);
